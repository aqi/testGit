...
struct panel_cmd_seq {
	...
	261,
	{
		...
		{ 0x23, 0x00, 0x02, 0x01, 0x71 },
		{ 0x23, 0x00, 0x02, 0x27, 0x71 },
		{ 0x23, 0x00, 0x02, 0x51, 0x71 },
		{ 0x23, 0x00, 0x02, 0x78, 0x71 },
		{ 0x23, 0x00, 0x02, 0x9E, 0x71 },
		{ 0x23, 0x00, 0x02, 0xC6, 0x71 },
		{ 0x23, 0x00, 0x02, 0x02, 0x89 },
		{ 0x23, 0x00, 0x02, 0x28, 0x89 },
		{ 0x23, 0x00, 0x02, 0x52, 0x89 },
		{ 0x23, 0x00, 0x02, 0x79, 0x89 },
		{ 0x23, 0x00, 0x02, 0x9F, 0x89 },
		{ 0x23, 0x00, 0x02, 0xC7, 0x89 },
		{ 0x23, 0x00, 0x02, 0x03, 0x9E },
		{ 0x23, 0x00, 0x02, 0x29, 0x9E },
		{ 0x23, 0x00, 0x02, 0x53, 0x9E },
		{ 0x23, 0x00, 0x02, 0x7A, 0x9E },
		{ 0x23, 0x00, 0x02, 0xA0, 0x9E },
		{ 0x23, 0x00, 0x02, 0xC8, 0x9E },
		{ 0x23, 0x00, 0x02, 0x09, 0x00 },
		{ 0x23, 0x00, 0x02, 0x05, 0xB0 },
		{ 0x23, 0x00, 0x02, 0x31, 0x00 },
		{ 0x23, 0x00, 0x02, 0x2B, 0xB0 },
		{ 0x23, 0x00, 0x02, 0x5A, 0x00 },
		{ 0x23, 0x00, 0x02, 0x55, 0xB0 },
		{ 0x23, 0x00, 0x02, 0x80, 0x00 },
		{ 0x23, 0x00, 0x02, 0x7C, 0xB0 },
		{ 0x23, 0x00, 0x02, 0xA7, 0x00 },
		{ 0x23, 0x00, 0x02, 0xA3, 0xB0 },
		{ 0x23, 0x00, 0x02, 0xCE, 0x00 },
		{ 0x23, 0x00, 0x02, 0xCA, 0xB0 },
		{ 0x23, 0x00, 0x02, 0x06, 0xC0 },
		{ 0x23, 0x00, 0x02, 0x2D, 0xC0 },
		{ 0x23, 0x00, 0x02, 0x56, 0xC0 },
		{ 0x23, 0x00, 0x02, 0x7D, 0xC0 },
		{ 0x23, 0x00, 0x02, 0xA4, 0xC0 },
		{ 0x23, 0x00, 0x02, 0xCB, 0xC0 },
		{ 0x23, 0x00, 0x02, 0x07, 0xCF },
		{ 0x23, 0x00, 0x02, 0x2F, 0xCF },
		{ 0x23, 0x00, 0x02, 0x58, 0xCF },
		{ 0x23, 0x00, 0x02, 0x7E, 0xCF },
		{ 0x23, 0x00, 0x02, 0xA5, 0xCF },
		{ 0x23, 0x00, 0x02, 0xCC, 0xCF },
		{ 0x23, 0x00, 0x02, 0x08, 0xDD },
		{ 0x23, 0x00, 0x02, 0x30, 0xDD },
		{ 0x23, 0x00, 0x02, 0x59, 0xDD },
		{ 0x23, 0x00, 0x02, 0x7F, 0xDD },
		{ 0x23, 0x00, 0x02, 0xA6, 0xDD },
		{ 0x23, 0x00, 0x02, 0xCD, 0xDD },
		{ 0x23, 0x00, 0x02, 0x0E, 0x15 },
		{ 0x23, 0x00, 0x02, 0x0A, 0xE9 },
		{ 0x23, 0x00, 0x02, 0x36, 0x15 },
		{ 0x23, 0x00, 0x02, 0x32, 0xE9 },
		{ 0x23, 0x00, 0x02, 0x5F, 0x15 },
		{ 0x23, 0x00, 0x02, 0x5B, 0xE9 },
		{ 0x23, 0x00, 0x02, 0x14, 0x36 },
		{ 0x23, 0x00, 0x02, 0x42, 0xAA },
		{ 0x23, 0x00, 0x02, 0x3D, 0x36 },
		{ 0x23, 0x00, 0x02, 0x69, 0xAA },
		{ 0x23, 0x00, 0x02, 0x65, 0x36 },
		{ 0x23, 0x00, 0x02, 0x8F, 0xAA },
		{ 0x23, 0x00, 0x02, 0x8B, 0x36 },
		{ 0x23, 0x00, 0x02, 0xB7, 0xAA },
		{ 0x23, 0x00, 0x02, 0xB3, 0x36 },
		{ 0x23, 0x00, 0x02, 0xDD, 0xAA },
		{ 0x23, 0x00, 0x02, 0xD9, 0x36 },
		{ 0x23, 0x00, 0x02, 0x15, 0x74 },
		{ 0x23, 0x00, 0x02, 0x3F, 0x74 },
		{ 0x23, 0x00, 0x02, 0x66, 0x74 },
		{ 0x23, 0x00, 0x02, 0x8C, 0x74 },
		{ 0x23, 0x00, 0x02, 0xB4, 0x74 },
		{ 0x23, 0x00, 0x02, 0xDA, 0x74 },
		{ 0x23, 0x00, 0x02, 0x16, 0x9F },
		{ 0x23, 0x00, 0x02, 0x40, 0x9F },
		{ 0x23, 0x00, 0x02, 0x67, 0x9F },
		{ 0x23, 0x00, 0x02, 0x8D, 0x9F },
		{ 0x23, 0x00, 0x02, 0xB5, 0x9F },
		{ 0x23, 0x00, 0x02, 0xDB, 0x9F },
		{ 0x23, 0x00, 0x02, 0x17, 0xDC },
		{ 0x23, 0x00, 0x02, 0x41, 0xDC },
		{ 0x23, 0x00, 0x02, 0x68, 0xDC },
		{ 0x23, 0x00, 0x02, 0x8E, 0xDC },
		{ 0x23, 0x00, 0x02, 0xB6, 0xDC },
		{ 0x23, 0x00, 0x02, 0xDC, 0xDC },
		{ 0x23, 0x00, 0x02, 0x1D, 0xFF },
		{ 0x23, 0x00, 0x02, 0x19, 0x03 },
		{ 0x23, 0x00, 0x02, 0x47, 0xFF },
		{ 0x23, 0x00, 0x02, 0x43, 0x03 },
		{ 0x23, 0x00, 0x02, 0x6E, 0xFF },
		{ 0x23, 0x00, 0x02, 0x6A, 0x03 },
		{ 0x23, 0x00, 0x02, 0x94, 0xFF },
		{ 0x23, 0x00, 0x02, 0x90, 0x03 },
		{ 0x23, 0x00, 0x02, 0xBC, 0xFF },
		{ 0x23, 0x00, 0x02, 0xB8, 0x03 },
		{ 0x23, 0x00, 0x02, 0xE2, 0xFF },
		{ 0x23, 0x00, 0x02, 0xDE, 0x03 },
		{ 0x23, 0x00, 0x02, 0x1A, 0x35 },
		{ 0x23, 0x00, 0x02, 0x44, 0x35 },
		{ 0x23, 0x00, 0x02, 0x6B, 0x35 },
		{ 0x23, 0x00, 0x02, 0x91, 0x35 },
		{ 0x23, 0x00, 0x02, 0xB9, 0x35 },
		{ 0x23, 0x00, 0x02, 0xDF, 0x35 },
		{ 0x23, 0x00, 0x02, 0x1B, 0x45 },
		{ 0x23, 0x00, 0x02, 0x45, 0x45 },
		{ 0x23, 0x00, 0x02, 0x6C, 0x45 },
		{ 0x23, 0x00, 0x02, 0x92, 0x45 },
		{ 0x23, 0x00, 0x02, 0xBA, 0x45 },
		{ 0x23, 0x00, 0x02, 0xE0, 0x45 },
		{ 0x23, 0x00, 0x02, 0x1C, 0x55 },
		{ 0x23, 0x00, 0x02, 0x46, 0x55 },
		{ 0x23, 0x00, 0x02, 0x6D, 0x55 },
		{ 0x23, 0x00, 0x02, 0x93, 0x55 },
		{ 0x23, 0x00, 0x02, 0xBB, 0x55 },
		{ 0x23, 0x00, 0x02, 0xE1, 0x55 },
		{ 0x23, 0x00, 0x02, 0x22, 0xFF },
		{ 0x23, 0x00, 0x02, 0x1E, 0x68 },
		{ 0x23, 0x00, 0x02, 0x4C, 0xFF },
		{ 0x23, 0x00, 0x02, 0x48, 0x68 },
		{ 0x23, 0x00, 0x02, 0x73, 0xFF },
		{ 0x23, 0x00, 0x02, 0x6F, 0x68 },
		{ 0x23, 0x00, 0x02, 0x99, 0xFF },
		{ 0x23, 0x00, 0x02, 0x95, 0x68 },
		{ 0x23, 0x00, 0x02, 0xC1, 0xFF },
		{ 0x23, 0x00, 0x02, 0xBD, 0x68 },
		{ 0x23, 0x00, 0x02, 0xE7, 0xFF },
		{ 0x23, 0x00, 0x02, 0xE3, 0x68 },
		{ 0x23, 0x00, 0x02, 0x1F, 0x7E },
		{ 0x23, 0x00, 0x02, 0x49, 0x7E },
		{ 0x23, 0x00, 0x02, 0x70, 0x7E },
		{ 0x23, 0x00, 0x02, 0x96, 0x7E },
		{ 0x23, 0x00, 0x02, 0xBE, 0x7E },
		{ 0x23, 0x00, 0x02, 0xE4, 0x7E },
		{ 0x23, 0x00, 0x02, 0x20, 0x97 },
		{ 0x23, 0x00, 0x02, 0x4A, 0x97 },
		{ 0x23, 0x00, 0x02, 0x71, 0x97 },
		{ 0x23, 0x00, 0x02, 0x97, 0x97 },
		{ 0x23, 0x00, 0x02, 0xBF, 0x97 },
		{ 0x23, 0x00, 0x02, 0xE5, 0x97 },
		{ 0x23, 0x00, 0x02, 0x21, 0xB5 },
		{ 0x23, 0x00, 0x02, 0x4B, 0xB5 },
		{ 0x23, 0x00, 0x02, 0x72, 0xB5 },
		{ 0x23, 0x00, 0x02, 0x98, 0xB5 },
		{ 0x23, 0x00, 0x02, 0xC0, 0xB5 },
		{ 0x23, 0x00, 0x02, 0xE6, 0xB5 },
		{ 0x23, 0x00, 0x02, 0x25, 0xF0 },
		{ 0x23, 0x00, 0x02, 0x23, 0xE8 },
		{ 0x23, 0x00, 0x02, 0x4F, 0xF0 },
		{ 0x23, 0x00, 0x02, 0x4D, 0xE8 },
		{ 0x23, 0x00, 0x02, 0x76, 0xF0 },
		{ 0x23, 0x00, 0x02, 0x74, 0xE8 },
		{ 0x23, 0x00, 0x02, 0x9C, 0xF0 },
		{ 0x23, 0x00, 0x02, 0x9A, 0xE8 },
		{ 0x23, 0x00, 0x02, 0xC4, 0xF0 },
		{ 0x23, 0x00, 0x02, 0xC2, 0xE8 },
		{ 0x23, 0x00, 0x02, 0xEA, 0xF0 },
		{ 0x23, 0x00, 0x02, 0xE8, 0xE8 },
		{ 0x23, 0x00, 0x02, 0x24, 0xFF },
		{ 0x23, 0x00, 0x02, 0x4E, 0xFF },
		{ 0x23, 0x00, 0x02, 0x75, 0xFF },
		{ 0x23, 0x00, 0x02, 0x9B, 0xFF },
		{ 0x23, 0x00, 0x02, 0xC3, 0xFF },
		{ 0x23, 0x00, 0x02, 0xE9, 0xFF },
		{ 0x23, 0x00, 0x02, 0xFE, 0x3D },
		{ 0x23, 0x00, 0x02, 0x00, 0x04 },
		{ 0x23, 0x00, 0x02, 0xFE, 0x23 },
		{ 0x23, 0x00, 0x02, 0x08, 0x82 },
		{ 0x23, 0x00, 0x02, 0x0A, 0x00 },
		{ 0x23, 0x00, 0x02, 0x0B, 0x00 },
		{ 0x23, 0x00, 0x02, 0x0C, 0x01 },
		{ 0x23, 0x00, 0x02, 0x16, 0x00 },
		{ 0x23, 0x00, 0x02, 0x18, 0x02 },
		{ 0x23, 0x00, 0x02, 0x1B, 0x04 },
		{ 0x23, 0x00, 0x02, 0x19, 0x04 },
		{ 0x23, 0x00, 0x02, 0x1C, 0x81 },
		{ 0x23, 0x00, 0x02, 0x1F, 0x00 },
		{ 0x23, 0x00, 0x02, 0x20, 0x03 },
		{ 0x23, 0x00, 0x02, 0x23, 0x04 },
		{ 0x23, 0x00, 0x02, 0x21, 0x01 },
		{ 0x23, 0x00, 0x02, 0x54, 0x63 },
		{ 0x23, 0x00, 0x02, 0x55, 0x54 },
		{ 0x23, 0x00, 0x02, 0x6E, 0x45 },
		{ 0x23, 0x00, 0x02, 0x6D, 0x36 },
		{ 0x23, 0x00, 0x02, 0xFE, 0x3D },
		{ 0x23, 0x00, 0x02, 0x55, 0x78 },
		{ 0x23, 0x00, 0x02, 0xFE, 0x20 },
		{ 0x23, 0x00, 0x02, 0x26, 0x30 },
		{ 0x23, 0x00, 0x02, 0xFE, 0x3D },
		{ 0x23, 0x00, 0x02, 0x20, 0x71 },
		{ 0x23, 0x00, 0x02, 0x50, 0x8F },
		{ 0x23, 0x00, 0x02, 0x51, 0x8F },
		{ 0x23, 0x00, 0x02, 0xFE, 0x00 },
		{ 0x23, 0x00, 0x02, 0x35, 0x00 },
		{ 0x05, 0x78, 0x01, 0x11 },
		{ 0x05, 0x1E, 0x01, 0x29 },
	},
};
                  ...
                  const struct mipi_dsi_msg *msg)
{
	...
	while (packet.payload_length >= 4) {
		...
		dev_info(rk628->dev, "dsi payload: 0x%x\n", val);
	...
	dev_info(rk628->dev, "dsi hdr: 0x%x\n", val);
...
static int panel_simple_xfer_dsi_cmd_seq(struct rk628 *rk628)
{
	const struct panel_cmd_seq *panel_init_seq = &panel_cmd_init_seq;
	u8 data_type, ms, payload_length;
	u16 cmds_cnt;
	const u8 *payload;
	int err;

    for (cmds_cnt = 0; cmds_cnt < panel_init_seq->cmd_cnt; cmds_cnt++) {
		    data_type = panel_init_seq->init_sequence[cmds_cnt][0];
		    ms = panel_init_seq->init_sequence[cmds_cnt][1];
		    payload_length = panel_init_seq->init_sequence[cmds_cnt][2];
		    payload = &panel_init_seq->init_sequence[cmds_cnt][3];
		...
		case MIPI_DSI_GENERIC_SHORT_WRITE_2_PARAM:
		case MIPI_DSI_GENERIC_LONG_WRITE:
			err = rk628_mipi_dsi_generic_write(rk628, payload,
							   payload_length);
			break;
		case MIPI_DSI_DCS_SHORT_WRITE:
		case MIPI_DSI_DCS_SHORT_WRITE_PARAM:
		case MIPI_DSI_DCS_LONG_WRITE:
			err = rk628_mipi_dsi_dcs_write_buffer(rk628, payload,
							      payload_length);
			break;
		default:
...
void rk628_dsi_enable(struct rk628 *rk628)
{
	const struct rk628_dsi *dsi = rk628_display_get_dsi0_host();
	const struct rk628_dsi *dsi1 = rk628_display_get_dsi1_host();
	...
	lane_mbps = rk628_combtxphy_get_bus_width();
	...
	panel_simple_xfer_dsi_cmd_seq(rk628);
