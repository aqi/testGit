...
{
	struct rk628_display_mode *src = rk628_display_get_src_mode();
	const struct rk628_display_mode *dst = rk628_display_get_dst_mode();
...
static void rk628_post_process_csc(struct rk628 *rk628)
{
	...
	in_fmt = rk628_get_input_bus_format();
	out_fmt = rk628_get_output_bus_format();
